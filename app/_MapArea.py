...
"""autogenerated by genpy from mower_map/MapArea.msg. Do not edit."""
import codecs
import sys
...
class MapArea(genpy.Message):
  _md5sum = "e05337fee1075a1bed5387053316b30b"
  _type = "mower_map/MapArea"
...
float32 y
float32 z"""
  __slots__ = ['name','area','obstacles']
  _slot_types = ['string','geometry_msgs/Polygon','geometry_msgs/Polygon[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MapArea, self).__init__(*args, **kwds)
